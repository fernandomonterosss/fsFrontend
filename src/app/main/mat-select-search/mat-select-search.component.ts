import {
  ...
  export class MatSelectSearchComponent implements OnInit, OnDestroy, AfterViewInit, ControlValueAccessor {
    ...
    @Input() noEntriesFoundLabel = 'No Existen Opciones';
  
    /** Reference to the search input field */
   //CAQG @ViewChild('searchSelectInput', {read: ElementRef}) searchSelectInput: ElementRef;
   @ViewChild('searchSelectInput', {static: false}) searchSelectInput: ElementRef
