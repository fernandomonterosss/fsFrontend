...
@Component({
  selector: 'eliminaorden',
  templateUrl: './eliminaorden.component.html',
  styleUrls  : ['./eliminaorden.component.scss'],
  encapsulation: ViewEncapsulation.None,
})



export class EliminaOrdenComponent implements  OnInit, AfterViewInit {
    Id: number;
    nombre:string;
    orden: Orden;
    estadoOrden;
 ...
 btnCancel(orden){
  ...
  this.estadoOrdenService.deleteOrden(orden) 
 ...
 btnOrden(url,id){
    ...
    var myurl = `${url}${id}/${nombre}/${orden}/4`;
    ...
    loadOrdenes(Orden :string,Estado :string,Responsable :string, filter: string,
               ...
               .pipe(
                ...
                finalize(() => this.loadingSubject.next(false))
                    ...
                    console.log('ordenes',ordenes["payload"])
